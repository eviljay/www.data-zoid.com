<HTML><HEAD>
<TITLE>colonpipe.com :: don't jump on the cat
...
<span class"lineyear">My point is that OH LOOK A KITTEN
</span>
</TD>
...
<table width="100%" cellpadding="1" cellspacing="1"><tr><td class="menuhead">&nbsp;The colonpipe.com guide to colonpipe.com</td></tr></table>
<BR>
<CENTER><IMG SRC="images/guide.gif" width="383" height="775"></CENTER><BR>
<BR>
<SPAN CLASS="comment">1</SPAN>. Random quote. Usually from Gremmi. Generated from a text file of random quotes. Quote collection is changed occasionally.<BR>
<BR>
<SPAN CLASS="comment">2</SPAN>. Title image. Randomised from a bunch of images. Some are funny. Some are not.<BR>
<BR>
<SPAN CLASS="comment">3</SPAN>. Stupid "quick navigation" menu thing that no one uses.<BR>
<BR>
<SPAN CLASS="comment">4</SPAN>. Navigation system for the website. All of the colonpipe.com departments live in the top section, along with a few random pages that don't really classify as departments that have been unceremoniously crowbarred in here.<BR>
<BR>
<SPAN CLASS="comment">5</SPAN>. The Colonpipes. This is a comic that's generated at random from a bunch of images. Some frames have been generously created by Miek in the style of <a href="fraxyl/roughing">Roughing It</a>, and don't fit in at all. This adds to the effect, claim all and sundry.<BR>
<BR>
<SPAN CLASS="comment">6</SPAN>. A bunch of buttons. The top handful are buttons for various colonpipe.com departments, the rest are people who've requested link exchanges or are otherwise decent enough to have earned a spot on every page of the freaking website.<BR>
<BR>
<SPAN CLASS="comment">7</SPAN>. A popup menu of articles. Most of which are a) outdated, and b) really crap. If this was a decent website, this is the spot you'd find <i>content</i>. This is not a decent website, however, so this is the spot you find cobwebs and the occasional misplaced literary turd.<BR>
<BR>
<SPAN CLASS="comment">8</SPAN>. A timeline of inconsequential events occuring in the vicinity of a chatroom nobody cares about.<BR>
<BR>
<SPAN CLASS="comment">9</SPAN>. A link to our online store, where you can buy approximately four really crappy items to wear in the privacy of your own home. When no one else is around. With a jacket over.<BR>
<BR>
<SPAN CLASS="comment">10</SPAN>. Really, really, really old carry-overs from my first website.<BR>
<BR>
<SPAN CLASS="comment">11</SPAN>. Housekeeping stuff. E-mail system links, archives of crap, privacy policies (hah), how to link to this website, whatnot. Nothing exciting. (See also: Everywhere else.)<BR>
<BR>
<SPAN CLASS="comment">12</SPAN>. Flat Pickled Cap articles. Articles explaining in ridiculous detail the origins and point of various extremely dated online jokes.<BR>
<BR>
<SPAN CLASS="comment">13</SPAN>. Archives of vaguely amusing things said by individuals in a chatroom no-one visits.<BR>
<BR>
<SPAN CLASS="comment">14</SPAN>. Glossary of outdated online terminology.<BR>
<BR>
<SPAN CLASS="comment">15</SPAN>. Links to people we think we like.<BR>
<BR>
<SPAN CLASS="comment">16</SPAN>. Links to people we think are educational.<BR>
<BR>
<SPAN CLASS="comment">17</SPAN>. Links to people we'd nod to in the street, but not look in the eye.<BR>
<BR>
<SPAN CLASS="comment">18</SPAN>. The space where updates occasionaly appear. Otherwise known as a "blog", but the term is generally despised. Like chutney.<BR>
<BR>
<SPAN CLASS="comment">19</SPAN>. A link apparently no-one knows exists.<BR>
<BR>
<SPAN CLASS="comment">20</SPAN>. Joke banner advertisements.<BR>
<BR>
<SPAN CLASS="comment">21</SPAN>. Copyright notice. Scripted to change at random.<BR>
<BR>
<SPAN CLASS="comment">22</SPAN>. Block of disturbing grey text.<BR>
<BR>
I'm sorry. Did you actually just read all that?<BR>
<BR>
Get a life. Seriously.<BR>
<BR>
...
<BR>
<BR>
<IMG SRC="images/ad_hnery.gif" WIDTH="440" HEIGHT="60" border="0">
<BR>
<BR>
