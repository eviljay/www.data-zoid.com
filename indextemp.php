<HTML><HEAD>
<TITLE>colonpipe.com :: don't free the lemons
...
<span class"lineyear">Men are shallow. We don't give two hoots, basically. <img src="yahoo_poker.gif" width="12" height="12" align="middle">
</span>
</TD>
...
<BR><BR>or<BR><BR><img src="images/randomimages/bread.jpg" width="70" height="40"><BR>Bread
</span></center></TD><TD WIDTH="7" CLASS="rightSide" HEIGHT="10">&nbsp;</TD></TR></TABLE>
</TD>
...
<table width="100%" cellpadding="1" cellspacing="1"><tr><td class="menuhead">&nbsp;Colonpipe.com</td></tr></table>
<BR>
I just received this e-mail through the e-mail form, suggesting that at best, it's not actually automated. Possibly cut'n'pasted, though. Still. Amusing, somewhat.<BR>
<BLOCKQUOTE>PEACE UNTO YOU THERE, <BR>
I FORWARD THIS MAIL TO YOU IN ORDER TO PURCHASE ( BIBLES BONDED LEATHER 200 COPIES ) THE BIBLE ARE FOR THE CHURCH TRAINING CLASES, KINDLY CALCULATE THE TOTAL PRICE WITH THE SHIPPING COST VIA \" AIR MAIL PARCEL POST 7-10 DAYS SHIPMENT OR BY AIR FREIGHT TO AIRPORT TO NIGERIA. WE NEED THEM WITHOUT DELAY. <BR>
STAY BLESS <BR>
REV. AYOBOLA</BLOCKQUOTE>
I'm somewhat confused as to where "selling Bibles" and "colonpipe.com" coincide, but I give the man kudos for demanding leatherbound volumes. I mean, classy is classy, right?<BR>
<BR>
God bless!<BR>
<BR>
EDIT: Wait, I just realised where the <a href="http://rafters.data-zoid.com/viewtopic.php?t=1468">Bibles come into it</a>.<BR>
<BR>
- <SPAN CLASS="comment">Datazoid</SPAN> - <SPAN STYLE="color: #76B201;">29/12 2004</SPAN>.<BR>
<BR>
<HR>
<BR>
<CENTER><IMG SRC="photos/wurm_shatner.jpg" WIDTH="320" HEIGHT="240" BORDER="0"><BR>
<SPAN CLASS="tiny">In an act inspired by the astounding <a href="http://www.fullyramblomatic.com/essays/erwin" target="new">Erwin Wurm</a>, I successfully<BR> balance William Shatner's album, <i>Has Been</i>, ON MY FACE.<BR></SPAN></CENTER><BR>
<BR>
- <SPAN CLASS="comment">Datazoid</SPAN> - <SPAN STYLE="color: #76B201;">29/12 2004</SPAN>.<BR>
<BR>
<HR>
<BR>
Um, the site's cocked up again. This time I can't log in to the administration panel. This is fantastic.<BR>
<BR>
ANYHOW.<BR>
<BR>
Added about 35 new MIDI files to the <a href="ozmidi.php">Ozmidi Archive</a> thanks to woody's contributions. There're a whole bunch more, but I haven't sorted through them yet.<BR>
<BR>
One way or another, the site will be operational again soon. Uh, I hope.<BR>
<BR>
- <SPAN CLASS="comment">Datazoid</SPAN> - <SPAN STYLE="color: #76B201;">29/12 2004</SPAN>.<BR>
<BR>
<HR>
<BR>
So, uh, the server's down again. So this is just a placeholder. Whee.<BR>
<BR>
I have a few articles brewing, but I'm choosing diplomatically not to tell anyone about them, because I know as soon as I do, I'll completely lose whatever vague interest I had in ever writing them. So..yes. Content is ahoy, it's just a matter of me getting off my arse and writing it. Also it's reliant on the server getting off its arse and..serving. Or whatever it does.<BR>
<BR>
My parents bought me a DVD of Puppetry Of The Penis for Christmas. Well, actually, my mother bought me Puppetry Of The Penis. My father bought me a tape measure. The Freudian implications of this I am not willing to explore. BUT ANYHOW.<BR>
<BR>
Brief synopsis: Stage. Two chaps enter. Chaps remove capes to reveal rather large, but obviously "well manipulated" phalluses. Chaps then proceed to stretch, distort and squash their cocks into various shapes only marginally less attractive than the wangs first appeared. The DVD suffers from a great many issues. <BR>
<BR>
1. It features two large, floppy cocks.<BR>
2. It's not really that funny.<BR>
3. It features two stretched, dangling willies.<BR>
4. The jokes are tired, to the extent of several "installations" (or manipulated cock shapes) being re-used under different names.<BR>
5. Constant featuring of two limp, drooping dicks.<BR>
6. It drags on and on over an astounding 50 minutes.<BR>
7. Cocks. x2.<BR>
<BR>
That said, there's an odd sense of achievement to having sat through almost-an-hour of watching two grown men leap about (sadly, they do indeed leap) with their willies in their palms, shouting various things into microphones and then attempting to meld their tired organs into said shapes.<BR>
<BR>
Anyhow. I'm optimistic the site will be up and running as expected soon. It usually only collapses for at worst, a couple of days at a time.<BR>
<BR>
- <SPAN CLASS="comment">Datazoid</SPAN> - <SPAN STYLE="color: #76B201;">27/12 2004</SPAN>.<BR>
<BR>
</TD>
...
<BR>
<BR>
<img src="ad_downanim.gif" width="468" height="60" border="0">
<BR>
<BR>
...
<BR>
<BR>
This page was generated in your feeble imagination.
<BR>
<BR></SPAN></div>
