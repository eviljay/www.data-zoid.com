...
<TD WIDTH="400"><IMG SRC="colonpipe33.jpg" WIDTH="400" HEIGHT="100">
</TD>
...
or<BR>
<BR>
<img src="images/randomimages/earmouse.jpg" width="70" height="40"><BR>Earmouse
</span></center>
</TD>
<TD WIDTH="7" CLASS="rightSide" HEIGHT="10">&nbsp;</TD>
</TR>
...
<table width="100%" cellpadding="1" cellspacing="1"><tr><td class="menuhead">&nbsp;Comment on data-zoid.com</td></tr></table>
<BR>
<span class="reg">Use this form to e-mail the administrator(s) of data-zoid.com! Wait, though. Read the following 'lil tiny rules, so we don't have to kill you:<BR>
<BR>
1. Kudos is appreciated. Criticism can be shoved up your arse. Sorry for being so blunt, but if you don't like it, don't look at it. <img src="yahoo_happy.gif"><BR>
2. Datazoid loves you, and he likes to know how much you love him. Particularly if you don't have a penis. Yee! Sexism!<BR>
3. The "submit" button works with uberEfficiency. Therefore, don't whack away at it like a monkey on speed. One copy of your message is sufficient.<BR>
4. Congratulations.</span><BR>
<form method="get" action="email_sent.php">
<input type="hidden" name="to" value="datazoid@data-zoid.com">
<input type="hidden" name="subject" value="OFFICIAL: data-zoid.com">
<DIV style="text-align: center;">
<table>
<tr>
...
<tr>
<td>
<span class="tiny">Message:</span><br>
<textarea name="message" style="width:300px; height:120px;" class="inputtxt"></textarea><br>
<br>
</td>
</tr>
</table>
<input type="submit" value="Submit. M'ghoy!" name="submit" style="width: 150px;" class="input"><br>
<br />
...
<BR>
<BR>
<SPAN CLASS="tiny">All content is &copy; Russ Gawthorpe, 2003 and all subsequent years, unless otherwise credited. Our lawyers are well-paid. (Not.)
<BR>
<BR>
