<HTML><HEAD>
<TITLE>colonpipe.com :: don't lick your mobile phone
...
<span class"lineyear"><img src="yahoo_poker.gif" width="12" height="12" align="middle"> @ a police van turning up at Sting's house, with Trudie saying "Oh, is it a re-union?"
</span>
</TD>
...
<TD WIDTH="400"><IMG SRC="colonpipe101.jpg" WIDTH="400" HEIGHT="100">
</TD>
...
<table width="100%" cellpadding="1" cellspacing="1"><tr><td class="menuhead">&nbsp;Acknowledgements, credits, confessions..</td></tr></table>
<BR>
<SPAN CLASS="comment">Webmaster and overall God:</SPAN><BR>
- Datazoid.<BR>
<BR>
<SPAN CLASS="comment">Graphics, occasional web design, Roughery artiste, fraxyl.data-zoid.com:</SPAN><BR>
- fraxyl.<BR>
<BR>
<SPAN CLASS="comment">Occasional Brutally Honest Movie Reviewer:</SPAN><BR>
- Gremmi.<BR>
<BR>
<SPAN CLASS="comment">Dead On Arrival:</SPAN><BR>
- Flatline.<BR>
<BR>
<SPAN CLASS="comment">Megaman Manipulator, Occasional Bannerist, now owns half the forum:</SPAN><BR>
- PD Natch.<BR>
<BR>
<SPAN CLASS="comment">Irregular Regular, Occasional Scriptmonkey, Vodkamobile Chauffer:</SPAN><BR>
- Evil Space Llama / Typo.<BR>
<BR>
<SPAN CLASS="comment">Resident poltergeist:</SPAN><BR>
- Raybrush ThreepDroid.<BR>
<BR>
<SPAN CLASS="comment">Random inspiration:</SPAN><BR>
- Beastie.<BR>
<BR>
<SPAN CLASS="comment">Rohr des Doppelpunktes:</SPAN><BR>
- Norman The Colonpipe.<BR>
<BR>
<SPAN CLASS="comment">Contributors:</SPAN><BR>
- Russ "Meh" Gawthorpe,<BR>
- Michael "Leem" Lander,<BR>
- Chris "Flat Pickled Cap" Grapes,<BR>
- Derek "Black Nipples" Hartley.<BR>
<BR>
<SPAN CLASS="comment">Photographic credit:</SPAN><BR>
- Tracey Parker,<BR>
- Russ Gawthorpe.<BR>
<BR>
<SPAN CLASS="comment">Hosting and technical credit:</SPAN><BR>
- data-zoid.com is hosted by <a href="http://www.phpwebhosting.com/">phpwebhosting</a>.<BR>
- data-zoid.com is registered with <a href="http://www.directnic.com/">DirectNIC</a>.<BR>
- phpBB 2.0 RC2 is the intellectual property of <a href="http://www.phpbb.com/">The phpBB Group</a>.<BR>
- phpGlossar is the intellectual property of <a href="http://www.crear.de">Andreas Robertz</a>.<BR>
- kounter is the intellectual property of <a href="http://www.zelreo.com/">www.zelreo.com</a>.<BR>
- Random Quote Script is the intellectual property of <a href="http://www.cerebuswebmaster.com/">www.cerebuswebmaster.com</a>.<BR>

<BR>
<SPAN CLASS="comment"><B>Disclaimer and copyright:</B></SPAN><BR>
This website is here for the purpose of entertainment. If anyone is offended by anything within the webspace this site is contained on, I take no responsibility for it. In fact, if you are, you're probably a complete prude and have difficulty walking down crowded streets.<BR>
<BR>
All content with exception to that contained within the directories "fraxyl", "brutallyhonest" and "flatline" or subject to ownership by the appropriately credited authorities is &copy; 2002, Russell Gawthorpe. Any duplication without prior express permission is not permitted.<BR>
<BR>
Many portions of this website contain quoted text from selected online personas ("chatclassics", "flat pickled cap", "flat pickled glossary"). Said quotations are always credited unless the original author is unknown. If any quoted persons wish their contributions removed, please <a href="email.php">e-mail</a> the appropriate request and it shall be made so.<BR>
<BR>
The posts and comments contained within <a href="rafters">Rafters</a> and the comments pages of <a href="index2.php">data-zoid.com home</a> are the opinions and property of those who posted, and do not represent the opinions of data-zoid.com, or its operators.<BR>
...
<BR>
<BR>
<SPAN CLASS="tiny">All content is &copy; Russ Gawthorpe, 2003 and all subsequent years, unless otherwise credited. IMAGE AND CONCEPT THEFT IS ILLEGAL.*<br><br>*..possibly.
<BR>
<BR>
