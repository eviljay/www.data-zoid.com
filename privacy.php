<HTML><HEAD>
<TITLE>colonpipe.com :: don't consult the mortuary
...
<span class"lineyear">Psh. Everyone knows that D-Day celebrations are just a big advertising campaign for Medal of Honour.
</span>
</TD>
...
<table width="100%" cellpadding="1" cellspacing="1"><tr><td class="menuhead">&nbsp;Privacy Policy</td></tr></table>
<BR>
I don't know if this has any legal bearings as an actual "privacy policy", as this website isn't really in the position to have one, but there are a few parts of this site that may collect personal information (or at worst your e-mail address), so I figure I should say something about it.<BR>
<BR>
<b>Rafters</b> requires a valid e-mail address for you to register. It's necessary for the forum to send out an automated confirmation e-mail before your account is activated. This is to stop robotic registration on the forum. The forum is configured so that any e-mail exchanged between forum members is sent through the forum itself and kept confidential.<BR>
<BR>
Occasionally, mass e-mails will be sent out from the Rafters forum to the e-mail addresses users use to register. According to the Spam Act of 2004 (Australian), this is not considered spam as the e-mail addresses used were supplied with consent.<BR>
<BR>
The <b>Rafters Photo Album</b> is publicly available and non-members are able to view photos posted in it.<BR>
<BR>
The <b>comments</b> feature on the main updates USED to display publicly the e-mail address supplied with any given post, in the absence of a URL. This is no longer the case. E-mail addresses provided are stored in the database for our reference, should a comment require a response via e-mail. It's optional to include an e-mail address with your comments, anyway.<BR>
<BR>
We take no responsibility for e-mail addresses left "out in the open", i.e. within the body of messages, comments or forum posts.<BR>
<BR>
Under no circumstances will data-zoid.com/colonpipe.com ever give away or sell e-mail addresses. So there.
<BR>
</TD>
...
<BR>
<BR>
This page was generated in your unconsciousness.
<BR>
<BR></SPAN></div>
