...
<span class"lineyear">"MY GRANDAD WAS A FISHERMAN!! YOU FUCK!
</span>
</TD>
...
<table width="100%" cellpadding="1" cellspacing="1"><tr><td class="menuhead">&nbsp;#colonpipe on EFnet.</td></tr></table>
<BR>
We have a channel on EFnet. It's maintained by Gremmi, and the idea is that it's to be a suitable place to discuss colonpipe-related matter. Or shoot the shit, as it were.<BR>
<BR>
<b>mIRC:</b><BR>
You can download mIRC from <a href="http://www.mirc.com/" target="new">here</a>. It'll pop up with a lot of weird options. Just put in your username,then put the server on any random EFnet one, then click connect. You can find a list of EFnet servers <a href="http://www.efnet.org/?module=servers" target="new">here</a>. Upon connect, a box will pop up with lots of channels in. Ignore them and type #colonpipe in the channel name box.<BR>
<BR>
<b>Java access</b><BR>
Even easier again, and particularly useful for those who chat at work, is the freshly installed Java applet, which you can <a href="irc/index.php">access by clicking here</a>. Enter your username and click your way in!<BR>
<BR>
Please bear in mind that EFnet is a busy network and has squillions of users online at any given moment, so you may not be able to use the nickname you want. Such is life.<BR>
<BR>
<b>And if that doesn't work:</b><BR>
Give up!<BR>
<BR>
..<BR>
<BR>
Or don't. You can try the <a href="http://www.colonpipe.com/cgi-bin/irc.cgi">CGI-based chat interface</a> instead. It's a bit slower, but it's potentially more compatible. Perhaps maybe.<BR>
<BR>
<b>Statistics:</b><BR>
Gremmi has kindly set up a <a href="http://www.colonpipe.com/gremmi/colonpipe.html">statistics</a> page here, with information generated from channel logs.<BR>
<BR>
<b>Basic commands:</b><BR>
To perform an action: /me<BR>
&nbsp;&nbsp;&nbsp;&nbsp;i.e. '/me leaps about' would appear as "Datazoid leaps about'.<BR>
<BR>
To send a private message: /msg username<BR>
Where username is the recipient. i.e. '/msg Datazoid hello' would send the message 'hello' to Datazoid.<BR>
<BR>
<b>Ops and ColinPope:</b><BR>
Gremmi and Datazoid are permanent channel ops. Other ops will come and go as necessary. Ops have the power to kick you off the channel and to ban you, if necessary. So don't be an arse.<BR>
ColinPope is the resident channel bot. He sits about, responds to occasional commands, and ops people when they come in. While he's got a bunch of useless crap installed also, his only function of practical use is to inform you of when someone was last online, through this command:<BR>
<BR>
!seen username<BR>
<BR>
Which should tell you when the person was last on. In some verbose and witty fashion.<BR>
<BR>
<b>ANYHOW.</b><BR>
Enjoy.<BR>
<BR>
