<HTML><HEAD>
<TITLE>colonpipe.com :: pepsi samba drink
...
<span class"lineyear">URE SILIMIE CLOCK IS TACKLING MY CLINT
</span>
</TD>
...
<TD WIDTH="400"><IMG SRC="colonpipe102.jpg" WIDTH="400" HEIGHT="100">
</TD>
...
<BR>
<img src="images/randomimages/oranges.jpg" width="70" height="40"><BR>Oranges
<BR>
<BR>
or<BR>
<BR>
...
<BR>
<DIV style="text-align: center;"><IMG SRC="images/ebr/ebr_pepsisamba_label.jpg" WIDTH="320" HEIGHT="240" ALT="Beverage Title!"><BR>
<BR>
<B>Pepsi Samba</B>
</DIV>
<BR>
...
<TD WIDTH="80"><SPAN CLASS="tiny">41.4cal</SPAN></TD>
</TR>
...
<TD WIDTH="80"><SPAN CLASS="tiny">10.9g</SPAN></TD>
</TR>
...
<BR>
<b>Horrid choice of flavours.</b><BR>
This stuff is mango and tamarind flavoured. Mango and tamarind. This does not sound pleasant. Mango is alright, I guess. Mango I can accept. Not sure about mango and Pepsi combined, but I'm okay with Mango. My only experience with tamarind, however, is an Asian "sweet" that consists of dried up balls of the fruit soaked in sugar and <i>chili powder</i>, producing a horrid, horrid, horrid burning mass of gross.<BR>
<BR>
<DIV style="text-align: center;"><IMG SRC="images/ebr/ebr_pepsisamba_bottle.jpg" WIDTH="240" HEIGHT="320" ALT="Beverage Bottle, glass"><BR>
<SPAN CLASS="tiny">For it was blue, with an orange top..</SPAN></DIV>
<BR>
<b>To the eye:</b><BR>
It's orange-er than regular Pepsi. Clearly there's some hint of tropical fruit about the colour.<BR>
<BR>
<DIV style="text-align: center;"><IMG SRC="images/ebr/ebr_pepsisamba_closeup.jpg" WIDTH="320" HEIGHT="240" ALT="Beverage closeup"><BR>
<SPAN CLASS="tiny">Brownish.</SPAN></DIV>
<BR>
<b>To the nose:</b><BR>
There's almost no smell. It smells like regular Pepsi, really, with a very very vague hint of that Tropical Sunkist crap they put out a few years ago. I'm under the assumption this is the same syrup, mixed with Pepsi. And tamarind.<BR>
<BR>
<b>To the mouth:</b><BR>
Oh, it's gross.  It tastes like Pepsi with soap in it. For anyone familiar with these drink reviews, it has the "we're trying to mask the taste of vitamin-B by adding overpowering fruit flavours" taste. Which wouldn't be a problem, except THIS ISN'T AN ENERGY DRINK, AND HAS NO VITAMIN B ADDED TO IT.<BR>
<BR>
<b>And a little while after:</b><BR>
It's horrid. It's still soapy. I'm having a hard time telling whether it's due to the base of this drink being regular Pepsi, which is pretty grim in its own right. Also, for some odd reason, there's a hint of eucalyptus or mint or something.<BR>
<BR>
<b>Overall:</b><BR>
Considering this is based on Pepsi to begin with, it's not that bad, I guess. It's soapy, but it's kind of fruity. Tropical Sunkist was better.<BR>
<BR>
...
<BR>
<BR>
<a href="http://fraxyl.data-zoid.com/roughing" border="0"><img src="http://fraxyl.data-zoid.com/images/ri_banner.gif" width="468" height="60" border="0"></a>
<BR>
<BR>
<SPAN CLASS="tiny">All content is &copy; Russ Gawthorpe, 2003 and all subsequent years, unless otherwise credited. The walrus may have farted, but we're not totally sure.
<BR>
<BR>
