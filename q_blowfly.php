<HTML><HEAD>
<TITLE>colonpipe.com :: what happens when an insect flies into your windshield?
...
<span class"lineyear">I can convince people that I'm nuts.
</span>
</TD>
...
<table width="100%" cellpadding="1" cellspacing="1"><tr><td class="menuhead">&nbsp;Question: What happens to an insect when it impacts your windshield?</td></tr></table>
<BR>
<DIV style="text-align: center;"><img src="images/ask.gif" width="400" height="42" alt="Ask Datazoid" /></DIV>
<BR>
<span class="comment">Noddy & Grant asks:</span> <i>what happens when a blowfly hits your wind screen?</i><BR>
<BR>
<span class="comment">Datazoid replies:</span><BR>
<BR>
<span class="red">Short Answer:</span> Some of it goes "splat" on the glass, some of it scoots over the top of your car.<BR>
<BR>
<span class="red">Long Answer:</span> This question's actually bugged (HAHA) me for a while. It's not so much "what happens when a blowfly hits your windscreen" as Noddy and Grant have asked, as much as it should be "why is there only liquid residue left after a bug hits the windshield, aren't bugs mostly made of hard stuff?" And the answer to this is that the liquid is what's contained in the bug sticks immediately to the glass and dries by virtue of the wind, and the shell of the insect immediately blows away. Imagine an egg in a wind tunnel, really. Splat, crunch, whoosh.<BR>
<BR>
<BR>
