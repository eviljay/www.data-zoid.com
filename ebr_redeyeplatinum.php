<HTML><HEAD>
<TITLE>colonpipe.com :: red eye platinum
...
<span class"lineyear">No. We just don't say moronic things like "The paint is alive, and suicidal" <img src="yahoo_poker.gif" width="12" height="12" align="middle"> 
</span>
</TD>
...
<TD WIDTH="400"><IMG SRC="colonpipe19.jpg" WIDTH="400" HEIGHT="100">
</TD>
...
<BR>
<img src="images/randomimages/sputnik.jpg" width="70" height="40"><BR>Sputnik
<BR>
<BR>
or<BR>
<BR>
...
<BR>
<DIV style="text-align: center;"><IMG SRC="images/ebr/ebr_redeyePlatinum_bottle.jpg" WIDTH="320" HEIGHT="240" ALT="Beverage Title!"><BR>
<BR>
<B>Red Eye: Platinum</B>
</DIV>
<BR>
<DIV style="text-align: center;">
<!-- begin stats table -->
...
<TD WIDTH="5"><TD>
<TD ALIGN="left"><SPAN CLASS="reg">"Energy Drink with Attitude", also "7 g ingredients", which I assume alludes to the various chemicals starting with "g" mixed into it.</SPAN></TD>
</TR>
...
<TD WIDTH="5"><TD>
<TD ALIGN="left"><SPAN CLASS="reg">Ginger, gotu kola, ginseng, gingo biloba, guarana, grapeseed and green tea with a twist of lime are the seven "g" ingredients listed above. The latter one frightens me somewhat. It also includes all the usual chemicals you'd expect, like caffeine, taurine, niacin, vitamin B6 and B12, pantothenic acid, inositol and a wheelbarrow full of sugar. (Assuming you have a wheelbarrow the size of three teaspoons, anyway.)<BR>
...
<TD WIDTH="5"><TD>
<TD ALIGN="left"><SPAN CLASS="reg">"Not recommended for children; and pregnant or lactating women; and individuals sensitive to caffeine. (Odd usage of semicolons preserved for posterity yet again.) Also, "CONTAINS CAFFEINE" is printed in a much larger typeface on these older bottles.</SPAN></TD>
</TR>
...
<TD WIDTH="5"><TD>
<TD ALIGN="left"><SPAN CLASS="reg">"Consume no more than two bottles per day."</SPAN></TD>
</TR>
...
<TD WIDTH="80"><SPAN CLASS="tiny">32mg</SPAN></TD>
</TR>
...
<TD WIDTH="80"><SPAN CLASS="tiny">1.5mg</SPAN></TD>
</TR>
...
<TR>
<TD WIDTH="120" BGCOLOR="#1A1A32" ALIGN="right"><SPAN CLASS="tiny" STYLE="color: #A197BF;">Inositol</SPAN></TD>
<TD ALIGN="left">
</TD>
<TD WIDTH="80"><SPAN CLASS="tiny">15.2mg</SPAN></TD>
</TR>
...
<TD WIDTH="80"><SPAN CLASS="tiny">1.5ug</SPAN></TD>
</TR>
...
<BR>
<DIV style="text-align: center;"><IMG SRC="images/ebr/ebr_redeyePlatinum.jpg" WIDTH="240" HEIGHT="320" ALT="Beverage Bottle, glass"><BR>
<SPAN CLASS="tiny">Fear the blue voodoo eye.</SPAN></DIV>
<BR>
<b>To the eye:</b><BR>
It looks pretty much the same as all the other "mild" types of Red Eye. This particular bottle was slightly warmer than the optimal drinking temperature, resulting in the usual spray of tiny bubbles manifesting themselves as massive bubbles instead.<BR>
<BR>
<DIV style="text-align: center;"><IMG SRC="images/ebr/ebr_redeyePlatinum_closeup.jpg" WIDTH="320" HEIGHT="240" ALT="Beverage closeup"><BR>
<SPAN CLASS="tiny">There are actually a lot more bubbles than it seems.</SPAN></DIV>
<BR>
<b>To the nose:</b><BR>
It smells strongly chemical, even to the extent of reminding me of a cleaning product. Like most Red Eye variations, there's a strong scent of sweetness, but it's hard to put a finger (or nostril) on what the actual smell is.<BR>
<BR>
<b>To the mouth:</b><BR>
It's sweet, and slightly fruity. Again, I can't define the actual fruit, but there's a definite fruitiness to it. Possibly peach or apricot, but without the furriness usually associated therewith. It should be noted that this stuff tastes quite vile when it's warm, quite akin to lawn clippings.<BR>
<BR>
<b>And a little while after:</b><BR>
Very little aftertaste. It has the same chemical-like residue that <a href="ebr_redeyeextreme.php">Red Eye Extreme</a> displayed, but otherwise it's not totally unpleasant.<BR>
<BR>
<b>Overall:</b><BR>
It's not unpleasant, really. It should be kept cold, however, as the taste it assumes when it warms up is quite sickening. At least it only tastes this way when it's warm, though. Most energy drinks taste like shredded lawn from the get-go.<BR>
<BR>
...
<BR>
<BR>
<IMG SRC="ad_colonpipes_banner.jpg" WIDTH="400" HEIGHT="60" border="0">
<BR>
<BR>
<SPAN CLASS="tiny">All content is &copy; Russ Gawthorpe, 2003 and all subsequent years, unless otherwise credited. So fuck you and your little dog too!
<BR>
<BR>
This page was generated in a cardboard box alongside the M4.
<BR>
<BR></SPAN></div>
