<HTML><HEAD>
<TITLE>colonpipe.com :: don't sleep in stitches
...
<span class"lineyear">RABID KITTY COMES BACK WHEN MY LIFE STARTS IMPROVING, SO FORGET YOU, CORKSOCKET.
</span>
</TD>
...
<TD WIDTH="400"><IMG SRC="colonpipe11.jpg" WIDTH="400" HEIGHT="100">
</TD>
...
<table width="100%" cellpadding="1" cellspacing="1"><tr><td class="menuhead">&nbsp;The :| Files</td></tr></table>
<BR>
- insert something about needing a life here -<BR>
<BR>
Anyhow. I was bored. So..yes. X-Files parody..thing. Complete with colonpipe.com references aplenty. Quicktime format. 1.2MB.<BR>
<BR>
<a href="movies/The_C_Files.mov">Download Here</a><BR>
<BR>
Here're a bunch of screengrabs of it, and what the hell they are (images on the right are the real thing, where available):<BR>
<BR>
<CENTER><IMG SRC="images/xfiles_parody/01_titlegraphic.jpg" width="160" height="120">&nbsp;&nbsp;<IMG SRC="images/xfiles_parody/01X_titlegraphic.jpg" width="160" height="120"></center><BR>
<SPAN CLASS="comment">The Title Graphic</SPAN><BR>
Fade in from black. The background waves a little bit, the shadowy colonpipe in the middleground moves to the side a little, the "THE :| FILES" text drifts to the left.<BR>
<BR>
<CENTER><IMG SRC="images/xfiles_parody/02_flyingsaucer.jpg" width="160" height="120">&nbsp;&nbsp;<IMG SRC="images/xfiles_parody/02X_flyingsaucer.jpg" width="160" height="120"></center><BR>
<SPAN CLASS="comment">The Flying Saucer</SPAN><BR>
Replaced with colonpipe. As in the original, it moves a step for each of four beats in the music. Text in the bottom corner reads "REALLY SECRET VIDEO OOPS" and some random numbers and chat text.<BR>
<BR>
<CENTER><IMG SRC="images/xfiles_parody/03_hallway.jpg" width="160" height="120"></center><BR>
<SPAN CLASS="comment">The Hallway</SPAN><BR>
Orginally a purple-tinted hallway shot as if it's from a security camera. Now it's an ineffectual glide down a 2-D photograph as Chris gurns into view holding a poorly photoshopped firearm! And apparently the government denies this. I would, too.<BR>
<BR>
<CENTER><IMG SRC="images/xfiles_parody/04_fbi_id_russ.jpg" width="160" height="120">&nbsp;&nbsp;<IMG SRC="images/xfiles_parody/05X_fbi_id.jpg" width="160" height="120"></center><BR>
<CENTER><IMG SRC="images/xfiles_parody/05_fbi_id_chris.jpg" width="160" height="120">&nbsp;&nbsp;<IMG SRC="images/xfiles_parody/05X_fbi_id.jpg" width="160" height="120"></center><BR>
<CENTER><IMG SRC="images/xfiles_parody/06_fbi_id_miek.jpg" width="160" height="120">&nbsp;&nbsp;<IMG SRC="images/xfiles_parody/05X_fbi_id.jpg" width="160" height="120"></center><BR>
<SPAN CLASS="comment">The FBI badges/credits</SPAN><BR>
These turned out kinda cool. "Camera" drifts over them, dissolves to the next one, etc. Found the image on Google, just in case the FBI is wondering.<BR>
<BR>
<CENTER><IMG SRC="images/xfiles_parody/07_handprint.jpg" width="160" height="120">&nbsp;&nbsp;<IMG SRC="images/xfiles_parody/07X_handprint.jpg" width="160" height="120"></center><BR>
<BR>
<SPAN CLASS="comment">The Handprint and Falling Man</SPAN><BR>
Traced around my own hand for this. I don't remember which actual segment is red in the original. I think it's the same one. The falling man is Dan, spinning and quite blurry.<BR>
<BR>
<CENTER><IMG SRC="images/xfiles_parody/08_wobbly_man.jpg" width="160" height="120">&nbsp;&nbsp;<IMG SRC="images/xfiles_parody/08X_wobbly_man.jpg" width="160" height="120"></center><BR>
<BR>
<SPAN CLASS="comment">The Wobbly Man</SPAN><BR>
Dan returns in the only segment that kinda lets this thing down a bit, in that I didn't really have a decent front-on and possibly screaming photograph of anyone to make wobble and distort. So Dan, who most will agree is suitably freaky enough to begin with, got the part.<BR>
<BR>
<CENTER><IMG SRC="images/xfiles_parody/09_eye.jpg" width="160" height="120"></center><BR>
<BR>
<SPAN CLASS="comment">The Eye</SPAN><BR>
This turned out quite cool. Snapped two photos with my digital camera, one of my eye open, one of it closed. Changed the colours about a bit, overlaid the red, made the camera drift towards it as per every other segment. Timed the blinks to coincide with the thuds in the music, all worked pretty well.<BR>
<BR>
<CENTER><IMG SRC="images/xfiles_parody/10_mountains.jpg" width="160" height="120"></center><BR>
<BR>
<SPAN CLASS="comment">The Mountains</SPAN><BR>
This is the only part that I think looks better than the original. It's all 2-D photos flogged off of Google, but the subtle drifting effect in the clouds makes it all look pretty dimensional and altogether spiffy. Then, for the final insult:<BR>
<BR>
<CENTER><IMG SRC="images/xfiles_parody/11_truth.jpg" width="160" height="120">&nbsp;&nbsp;<IMG SRC="images/xfiles_parody/11X_truth.jpg" width="160" height="120"></center><BR>
<BR>
<SPAN CLASS="comment">Heh</SPAN><BR>
And that's that.<BR>
<BR>
..<BR>
<BR>
This one was omitted because it turned out looking stupid:<BR>
<BR>
<CENTER><IMG SRC="images/xfiles_parody/20_voodootext.jpg" width="160" height="120">&nbsp;&nbsp;<IMG SRC="images/xfiles_parody/20X_voodootext.jpg" width="160" height="120"></center><BR>
<BR>
<SPAN CLASS="comment">The Voodoo Text</SPAN><BR>
It turned out looking like a shadow puppet. So I ditched it.<BR>
<BR>
...
<BR>
<BR>
<img src="ad_CPban3.jpg" width="468" height="60" border="0">
<BR>
<BR>
