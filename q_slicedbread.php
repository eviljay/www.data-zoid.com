<HTML><HEAD>
<TITLE>colonpipe.com :: where was sliced bread first sold?
...
<TD WIDTH="400"><IMG SRC="colonpipe104.jpg" WIDTH="400" HEIGHT="100">
</TD>
...
<table width="100%" cellpadding="1" cellspacing="1"><tr><td class="menuhead">&nbsp;Question: When and where was sliced bread first sold?</td></tr></table>
<BR>
<DIV style="text-align: center;"><img src="images/ask.gif" width="400" height="42" alt="Ask Datazoid" /></DIV>
<BR>
<span class="comment">PFA asks:</span> <i>When and where was sliced bread first sold?</i><BR>
<BR>
<span class="comment">Datazoid replies:</span><BR>
<BR>
<span class="red">Short Answer:</span> 1928, Battle Creek, Michigan.<BR>
<BR>
<span class="red">Long Answer:</span> A chap by the name of Otto Frederick Rohwedder evidently invented the first slicing machine in 1928. The first loaf of pre-sliced and wrapped bread was sold in a bakery in Battle Creek, Michigan in the same year (I assume). By 1933, 80% of all bread was sold pre-sliced.<BR>
<BR>
Further research contradicts this slightly: Another source suggests Mr. Rohwedder devised a slicing (but not slice'n'wrapping) machine in 1912, but bakeries were reluctant to use the thing for fear that sliced bread would go stale too quickly. The slice-and-wrap machine evidently solved this difficulty.<BR>
<BR>
I admit, this doesn't really answer the question. It's impossible to research when sliced bread itself was first sold, one would assume some bakeries did go to the trouble of pre-slicing loaves for people prior to the invention of the slicing machine.<BR>
<BR>
Anyone for toast?<BR>
<BR>
...
<BR>
<BR>
<a href="http://www.whatsbetter.com"><img src="antileetbanner.gif" width="468" height="60" border="0"></a>
<BR>
<BR>
