<HTML><HEAD>
<TITLE>colonpipe.com :: don't look at her
...
<span class"lineyear"><img src="yahoo_poker.gif" width="12" height="12" align="middle"> @ William H Macy leaping about like Donald Duck on some kind of hormone therapy.
</span>
</TD>
...
<table width="100%" cellpadding="1" cellspacing="1"><tr><td class="menuhead">&nbsp;Audio for your auditory auditing.</td></tr></table>
<BR>
<DIV ALIGN="center">Choose your format:<BR>
<BR>
<A HREF="original-midi.php"><IMG SRC="images/midi_banner.jpg" WIDTH="400" height="60" ALT="Audio in MIDI format" TITLE="Music of sorts in the format described eloquently as 'Musical Instrument Digital Interface'. These files can be played through Windows Media Player (at worst), Quicktime, or any MIDI-equipped device. Snifty, eh?" BORDER="0"></A><BR>
<BR>
..or..<BR>
<BR>
<A HREF="mp3.php"><IMG SRC="images/mp3_banner.jpg" WIDTH="400" height="60" ALT="Audio in MIDI format" TITLE="Music in mp3 format. These files can be played through WinAMP or iTunes, or any number of programs capable of decoding mp3 encoded noise." BORDER="0"></A><BR>
<BR></DIV>
<BR>
<SPAN CLASS="tiny" STYLE="color: #555555;">I don't know what the legality of using mp3 encoding is anymore. There was a time when it was illegal unless you had permission, but there was a time when .gif files were illegal without permission too. So..yeah.<BR>
<BR>
All of the mp3 recordings are original.<BR>
<BR>
</TD>
