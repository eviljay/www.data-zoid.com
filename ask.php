<HTML><HEAD>
<TITLE>colonpipe.com :: don't excommunicate the vicar
...
<span class"lineyear">Hah! No masturbation for you!
</span>
</TD>
...
<table width="100%" cellpadding="1" cellspacing="1"><tr><td class="menuhead">&nbsp;Ask Datazoid</td></tr></table>
<BR>
<DIV style="text-align: center;"><img src="images/ask.gif" width="400" height="42" alt="Ask Datazoid" /></DIV>
<BR>
<span class="comment">Questions Answered So Far:</span><BR>
- <a href="q_hotsex.php">How to have hot sex?</a> (<IMG SRC="yahoo_poker.gif" ALIGN="middle">)<BR>
- <a href="q_whalesfart.php">Do whales fart?</a><BR>
- <a href="q_nicename.php">What is your nice name?</a>  (<IMG SRC="yahoo_poker.gif" ALIGN="middle">)<BR>
- <a href="q_bulletsfired.php">Do falling bullets kill people?</a><BR>
- <a href="q_trafficlights.php">How do traffic lights know you're there?</a><BR>
- <a href="q_xfilestabs.php">Do you have The X-Files theme piano tabs?</a><BR>
- <a href="q_slicedbread.php">When and where was sliced bread first sold?</a><BR>
- <a href="q_brassieres.php">Who invented the first brassiere?</a><BR>
- <a href="q_humanmeat.php">What exactly would human flesh taste like?</a><BR>
- <a href="q_elevators.php">Who invented the elevator in the 16th century?</a><BR>
- <a href="q_bork.php">Is "Bork" really Swedish?</a><BR>
- <a href="q_weightonmars.php">How much would a 150lb person weigh on Mars?</a><BR>
- <a href="q_woodpeckers.php">Why don't woodpeckers get headaches?</a><BR>
- <a href="q_masturbation.php">Is masturbation wrong?</a><BR>
<BR>
<span class="comment">New:</span><BR>
- <a href="q_blowfly.php">What happens when an insect impacts your windshield?</a><BR>
- <a href="q_freefall.php">Has anyone ever fallen out of a plane without a parachute and survived?</a><BR>

<BR>
<span class="reg">This is a new and exceedingly original department of data-zoid.com wherein you can ask of Datazoid any question! However, in the interests of cleanliness, interest and public hygiene, we must provide a few minor stipulations, thus:<BR>
<BR>
1. Serious questions appreciated! Datazoid's bored, and wants to research stuff you've always wanted to know the answer to.<BR>
2. Personal questions probably won't be answered! Besides, you don't really care about that kind of thing, O user of the internet, you.<BR>
3. Datazoid is not <a href="http://www.straightdope.com/" target="new">Cecil Adams</a>, and doesn't fancy stealing his business. In the event a question's already been answered by he of the massive cerebrum, you'll be notified.<BR>
4. Messages regarding the site itself, or anything NOT actually a question can be flung <a href="email.php">this-a-way</a>.</span><BR>
<form method="get" action="asked.php">
<input type="hidden" name="to" value="datazoid@data-zoid.com">
<input type="hidden" name="subject" value="Ask Datazoid: Question">
<DIV style="text-align: center;">
<table>
<tr>
<td><span class="tiny">Name:</span><br />
<input type="text" name="name" style="width:300px;" class="inputtxt"></td></tr>
<tr>
<td><span class="tiny">Email:</span><br />
<input type="text" name="email" style="width:300px;" class="inputtxt"></td>
</tr>
<tr>
<td>
<span class="tiny">Question:</span><br>
<textarea name="message" style="width:300px; height:120px;" class="inputtxt"></textarea><br>
<br>
</td>
</tr>
</table>
<input type="submit" value="Ask!" name="submit" style="width: 150px;" class="input"><br>
<br />
<span class="tiny">Push. Submit. Button. <SPAN STYLE="color: #FF0000;">ONCE.</SPAN> Only.</span><br />
<br /></DIV>
</form></TD>
...
<BR>
<BR>
<img src="ad_Radiohead.jpg" width="468" height="60" border="0">
<BR>
<BR>
